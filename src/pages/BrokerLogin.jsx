...
const features = [
  {
    icon: FaChartBar,
    title: "Manage property leads",
    desc: "Advanced CRM tools for seamless conversion.",
  },
  {
    icon: FaDollarSign,
    title: "Track commissions",
    desc: "Instant visibility into your earnings and payouts.",
  },
  {
    icon: FaStar,
    title: "Access premium listings",
    desc: "Curated high-yield fractional property portfolios.",
  },
  {
    icon: FaTh,
    title: "Real-time sales dashboard",
    desc: "Live data analytics to drive your business growth.",
  },
];
    ...
    <div className="h-full flex items-center justify-center">
      <div className="w-full bg-gray-50 flex flex-col lg:flex-row rounded-2xl overflow-hidden shadow-xl">
        ...
        <div className="bg-[#1a5c4f] text-white flex flex-col justify-between p-8 lg:p-12 w-full lg:w-[48%]">
          ...
          <div>
            <p className="text-sm font-semibold tracking-wide mb-6 lg:mb-10">
              Sovereign Partners
            </p>
            ...
            <p className="text-sm text-green-100 mb-8 lg:mb-12 max-w-sm">
              Join our elite network of broker partners and access the most
              exclusive fractional assets in the market.
            </p>
          ...
          <div className="flex items-center gap-3 mt-10">
            <div className="flex -space-x-2">
              {[
                ...
                <div
                  key={i}
                  className={`w-8 h-8 rounded-full border-2 border-[#1a5c4f] ${c}`}
                />
              ))}
            </div>
            ...
            {step === 1 && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-[#1a5c47] hover:bg-[#155240] active:bg-[#0f3d2e] text-white font-bold py-3.5 rounded-2xl text-sm tracking-wide transition-all shadow-md hover:shadow-lg"
                >
                  Continue
                </button>
